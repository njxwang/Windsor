...
- Deprecated `WindsorContainer.Resolve(object/IDictionary)` in favour of `WindsorContainer.Resolve(Castle.MicroKernel.Arguments)` along with a reworked Arguments class and IReadOnlyDictionary extension methods (@fir3pho3nixx, #346)
